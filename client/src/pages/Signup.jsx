...
const styles = {
  ...
  title: { textAlign: 'center', color: '#28a745', marginBottom: 20 },
  input: { width: '100%', padding: 10, marginBottom: 14, border: '1px solid #ccc', borderRadius: 6, fontSize: 14, boxSizing: 'border-box' },
  btn: { width: '100%', padding: 12, background: '#28a745', color: 'white', border: 'none', borderRadius: 6, fontSize: 16, cursor: 'pointer' },
